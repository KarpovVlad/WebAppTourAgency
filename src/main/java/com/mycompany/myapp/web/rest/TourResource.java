...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Tour}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TourResource {
     ...
     */
    @GetMapping("/tours")
    public List<Tour> getAllTours(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
